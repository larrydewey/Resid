...
Int main() {
    ...
    RRes rr = imp_resolve_file(path, ";", 0);
    println(IntToString(str_len(rr.text)));
    println(str_slice(rr.text, 0, 40));
    Str src = rr.text;
