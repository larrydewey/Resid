...
Regex: System.Text.RegularExpressions with RegexOptions.Compiled (IL-compiled, still the standard managed engine), which is what the Benchmarks Game C# programs use and what idiomatic C# would pick for patterns applied to megabytes of text. No NonBacktracking, no source generator, no PCRE.
