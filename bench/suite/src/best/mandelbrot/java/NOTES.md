# mandelbrot / java (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/mandelbrot-javavm-2.html
...
- Run flags (as on the Benchmarks Game): none (`java -cp out mandelbrot`). Multithreaded.
