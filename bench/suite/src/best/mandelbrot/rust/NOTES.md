# mandelbrot — Rust, best track

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/mandelbrot-rust-4.html
(the fastest Rust program on the Benchmarks Game mandelbrot page at time of
adaptation, 0.95s there). Benchmarks Game programs are distributed under
...
Program: rayon parallel rows, portable 8-lane f64 vector struct auto-vectorised by LLVM.
