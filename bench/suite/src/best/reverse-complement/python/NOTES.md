# best / reverse-complement / python

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/revcomp-python3-5.html
(Benchmarks Game program `revcomp-python3-5`, author credits are in the file header.)
