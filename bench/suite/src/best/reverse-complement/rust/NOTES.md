# reverse-complement — Rust, best track

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/revcomp-rust-1.html
(the fastest Rust program on the Benchmarks Game reverse-complement page at time of
adaptation, 0.55s there). Benchmarks Game programs are distributed under
...
Program: rayon scoped parallel blocks, SSSE3 `std::arch` shuffles (with scalar fallback), memchr line scanning, raw fd I/O.
...
Dependencies: memchr 2.8.3, rayon 1.12.0 (lockfile).
