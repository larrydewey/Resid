# reverse-complement / csharp (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/revcomp-csharpcore-9.html
...
- Program characteristics: multithreaded, SSSE3/AVX2 (Vector128/Vector256) shuffle intrinsics, unsafe.
