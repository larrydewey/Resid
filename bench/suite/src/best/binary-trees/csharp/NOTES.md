# binary-trees / csharp (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/binarytrees-csharpcore-7.html
...
- Program characteristics: multithreaded (Tasks), class nodes, server GC.
