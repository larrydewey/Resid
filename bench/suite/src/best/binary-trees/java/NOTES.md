# binary-trees / java (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/binarytrees-javavm-7.html
...
- Run flags (as on the Benchmarks Game): none (`java -cp out binarytrees`). Multithreaded (ExecutorService).
