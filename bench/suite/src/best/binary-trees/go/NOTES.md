# binary-trees — Go, best track

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/binarytrees-go-2.html
(the fastest Go program on the Benchmarks Game binary-trees page at time of
adaptation, 14.21s there). Benchmarks Game programs are distributed under
...
Program: goroutines per depth, GC-managed nodes.
