# best / binary-trees / python

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/binarytrees-python3-4.html
(Benchmarks Game program `binarytrees-python3-4`, author credits are in the file header.)
