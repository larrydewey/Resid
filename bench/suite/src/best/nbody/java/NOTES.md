...
Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/nbody-javavm-4.html
...
- Run flags (as on the Benchmarks Game): none (`java -cp out nbody`). Single-threaded, scalar.
