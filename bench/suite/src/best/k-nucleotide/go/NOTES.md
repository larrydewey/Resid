# k-nucleotide — Go, best track

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/knucleotide-go-7.html
(the fastest Go program on the Benchmarks Game k-nucleotide page at time of
adaptation, 7.58s there). Benchmarks Game programs are distributed under
...
Program: NumCPU goroutines per k, each counting a slice of the sequence into its own built-in map with packed integer keys, then merged.
