# best / k-nucleotide / python

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/knucleotide-python3-3.html
(Benchmarks Game program `knucleotide-python3-3`, author credits are in the file header.)
