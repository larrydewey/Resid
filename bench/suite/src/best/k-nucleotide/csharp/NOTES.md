# k-nucleotide / csharp (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/knucleotide-csharpcore-1.html
...
- Program characteristics: multithreaded; uses Microsoft.Collections.Extensions.DictionarySlim from NuGet package Microsoft.Experimental.Collections 1.0.6-e190117-3 (restored from nuget.org at build time, as upstream).
