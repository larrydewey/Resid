# fannkuch-redux / java (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/fannkuchredux-javavm-1.html
...
- Run flags (as on the Benchmarks Game): none (`java -cp out fannkuchredux`). Multithreaded.
