# pidigits / csharp (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/pidigits-csharpcore-6.html
...
- Program characteristics: single-threaded; GMP via DllImport("gmp") (resolves to the system libgmp.so).
