# spectral-norm / csharp (best)

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/spectralnorm-csharpcore-5.html
...
- Program characteristics: multithreaded (Parallel.For), AVX intrinsics, unsafe.
