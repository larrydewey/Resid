# best / spectral-norm / python

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/spectralnorm-python3-4.html
(Benchmarks Game program `spectralnorm-python3-4`, author credits are in the file header.)
