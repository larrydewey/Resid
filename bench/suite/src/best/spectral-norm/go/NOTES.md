# spectral-norm — Go, best track

Source: https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/spectralnorm-go-4.html
(the fastest Go program on the Benchmarks Game spectral-norm page at time of
adaptation, 1.43s there). Benchmarks Game programs are distributed under
...
Program: rows split across NumCPU goroutines (GOMAXPROCS = NumCPU).
