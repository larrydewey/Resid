...
- **432 tests total**: lexer 13, parser 88, resid-ir 41, resid-type 154, resid-codegen 115,
  residc 21 (e2e). Destructuring, `_ = expr` discard,
...
- **Self-host roadmap**: detailed in §12. Conversion helpers (§12.1, task 5.1),
  ...
  Next: wide numerics (§12.1, task 5.9), handles (§12.1, task 5.7), spawn
